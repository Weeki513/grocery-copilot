...
export const copy = {
  en: {
    ...
    confirmed: "Order confirmed", confirmedBody: "We’ve started preparing your groceries.", orderNumber: "Order number", backHome: "Back to home",
  ...
  ru: {
    ...
    confirmed: "Заказ подтверждён", confirmedBody: "Мы уже начали собирать ваши продукты.", orderNumber: "Номер заказа", backHome: "На главную",
