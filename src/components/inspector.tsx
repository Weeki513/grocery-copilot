...
import { AlertTriangle, Check, ChevronRight, Circle, Clock3, Cpu, Database, Gauge, Layers3, LoaderCircle, Sparkles, Zap } from "lucide-react";
...
export function Inspector() {
  ...
  return <aside className="inspector-panel"><header className="inspector-header"><div className="inspector-brand"><span><Sparkles size={17}/></span><div><h1>{c.inspector}</h1><p>{c.inspectorSub}</p></div></div><span className={`run-status ${assistantStatus}`}><i/>{c[assistantStatus]}</span></header>
    ...
    <footer className="inspector-footer"><span className="inspector-links"><a href="https://pivnev.design" target="_blank" rel="noreferrer">made by pivnev.design</a><a href="https://github.com/Weeki513/grocery-copilot" target="_blank" rel="noreferrer">GitHub</a></span></footer>
