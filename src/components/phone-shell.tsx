...
const nav: Array<{ id: Screen; icon: typeof Home; label: "home" | "browse" | "assistant" | "cart" | "profile" }> = [
  { id: "home", icon: Home, label: "home" }, { id: "catalog", icon: Search, label: "browse" }, { id: "assistant", icon: Sparkles, label: "assistant" }, { id: "cart", icon: ShoppingBag, label: "cart" }, { id: "profile", icon: UserRound, label: "profile" },
];
